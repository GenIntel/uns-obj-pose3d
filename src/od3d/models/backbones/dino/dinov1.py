...
class ViTExtractor:
    ...
    def __init__(self, model_type: str = 'dino_vits8', model: nn.Module = None, device: str = 'cuda'):
        """
        ...
        self.model = ViTExtractor.patch_vit_resolution(self.model, stride=self.model.patch_embed.patch_size)
        self.model.eval()
