 # /scratch/sommerl/repos/NeMo/third_party/AutoRecon
deactivate
conda activate autorecon
...
mkdir -p ${DATA_ROOT}/${INST_REL_DIR}
cp -r /misc/lmbraid19/sommerl/datasets/CO3D/car/${SEQ}/images ${DATA_ROOT}/${INST_REL_DIR}
...
LOG_DIR="outputs/neusfacto-wbg-reg_sep-plane-nerf_60k_plane-h-ratio-0.3_co3d-scan1_cvpr/neus-facto-wbg-reg_sep-plane-nerf/2023-09-20_211422"
